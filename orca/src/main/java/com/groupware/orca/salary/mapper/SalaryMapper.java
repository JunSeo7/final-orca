...
//            "    , E.EMP_NO\n" +
//            "    , (E.SALARY * R.PENSION_PERCENTAGE) AS RENSION\n" +
//            "    , (E.SALARY * R.HEALTH_INSURANCE_PERCENTAGE) AS HEALTH\n" +
//            "    , (E.SALARY * R.HEALTH_INSURANCE_PERCENTAGE) * LONG_CARE_PERCENTAGE AS LONG_CARE\n" +
//            "    ,(E.SALARY*EMPLOYMENT_INSURANCE_PERCENTAGE) AS EMPLOYMENT\n" +
//            "    ,#{svo.incomeTax}\n" +
//            "    ,#{svo.localIncomeTax}\n" +
//            "    ,#{svo.position}\n" +
//            "    ,#{svo.bonus}\n" +
...
//            "    ,#{svo.overTimeWork}\n" +
//            "    ,#{svo.meals}\n" +
//            "    ,(E.SALARY - RENSION - HEALTH - LONG_CARE - EMPLOYMENT -#{svo.incomeTax}- #{svo.localIncomeTax} + #{svo.position} + #{svo.bonus} + #{svo.holiday} + #{svo.overTimeWork} + #{svo.meals})\n" +
//            "    ,SYSDATE\n" +
//            "FROM PERSONNEL_INFORMATION E, RATES R\n" +
//            "WHERE E.EMP_NO = #{vo.empNo}")
//    int salaryWrite(@Param("vo") UserVo vo,@Param("svo") SalaryVo svo, @Param("rvo") RatesVo rvo, double holidayTime, double overTime, double person, double position, double bonus, double meals);
//
//
//    //4대보험 입력 쿼리문
