...
public interface OrganizationChartMapper {
    ...
    @Select("SELECT E.NAME, P.NAME_OF_POSITION FROM PERSONNEL_INFORMATION E JOIN POSITION P ON P.POSITION_CODE = E.POSITION_CODE WHERE E.DEPT_CODE = #{deptCode} AND E.TEAM_CODE = #{teamCode} ORDER BY E.POSITION_CODE ASC")
