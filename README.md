...
| **기능** | - 게시판(자유, 익명)<br>- 검색, 정렬, 댓글, 대댓글<br>- 게시물 신고, 공유<br>- 게시물 통계, 좋아요, 북마크 | - 근태 관리<br>- 출퇴근 시간, 날짜 정보 기록<br>- 개인 출퇴근 정보 조회<br>- 휴가 병가, 기타 신청 | - 전자결재<br>- 결재양식등록, 수정, 삭제, 검색<br>- 결재문서작성, 수정, 삭제, 검색<br>- 기본 및 마이 결재선등록, 삭제 | - 캘린더(일정 관리)<br>- 관리자(사원 관리) | - 급여 작성<br>- 4대보험 요율<br>- 개인 명세서 |
